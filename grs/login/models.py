...
class CustomUser(AbstractUser):
    ...
    role = models.CharField(max_length=50, choices=[('Review Committee', 'Review Committee'), (
        'Assessment Committee', 'Assessment Committee'), ('HO', 'HO'), ('Faculty', 'Faculty')])
    ...
    permanent_employee = models.CharField(
        max_length=3, choices=[('Yes', 'Yes'), ('No', 'No')], blank=True)
